...
describe('validarPet', () => {
  ...
  test('normaliza data_nascimento para Date com horário zerado em UTC', () => {
    ...
    expect(resultado.valido).toBe(true);
    expect(resultado.dados.data_nascimento instanceof Date).toBeTruthy();
  ...
  test('aceita pet válido e normaliza campos opcionais vazios', () => {
    ...
    expect(resultado.dados.raca).toBe(null);
    expect(resultado.dados.data_nascimento).toBe(null);
    expect(resultado.dados.observacoes).toBe(null);
    expect(resultado.dados.foto_uri).toBe(null);
  });
});
